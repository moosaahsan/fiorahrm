...
@section('title', 'Modify Walk-in Interview Details')

@section('breadcrumb')
    <div class="col-sm-6 text-left">
        <h4 class="page-title interviews-header">Modify Walk-in Interview</h4>
        ...
        <form id="record-interview-form" class="premium-form-container" enctype="multipart/form-data">
            ...
            <div class="saas-card">
                <div class="saas-section-header">
                    ...
                    <h3 class="saas-section-title">Modify Candidate Identity</h3>
                </div>
                <div class="saas-form-body">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label class="saas-label"><i class="fas fa-signature"></i> Full Name</label>
                            <input type="text" class="saas-input" name="name" required value="{{ $interview->name }}"
                        ...
                        <div class="col-md-6 mb-4">
                            @if(auth()->user()->hasRole('receptionist'))
                                ...
                                <input type="text" class="saas-input" id="cnic" name="cnic" required
                                    value="{{ $interview->cnic }}" placeholder="Format: 37405-XXXXXXX-X">
                            @else
                                ...
                                <select class="saas-input" name="interview_type" required>
                                    <option value="Walk-in" {{ $interview->interview_type == 'Walk-in' ? 'selected' : '' }}>
                                        Walk-in</option>
                                    <option value="Referral" {{ $interview->interview_type == 'Referral' ? 'selected' : '' }}>
                                        Referral</option>
                                    <option value="Social Media" {{ $interview->interview_type == 'Social Media' || $interview->interview_type == 'Agency' ? 'selected' : '' }}>Social Media</option>
                                </select>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="saas-input" name="phone" required value="{{ $interview->phone }}"
                                placeholder="e.g. 0300-1234567">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="saas-label"><i class="fas fa-at"></i> Email Address</label>
                            <input type="email" class="saas-input" name="email" value="{{ $interview->email }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="saas-input" name="category" id="edit-category">
                                <option value="BPO" {{ $interview->category == 'BPO' ? 'selected' : '' }}>BPO</option>
                                <option value="Billing" {{ $interview->category == 'Billing' ? 'selected' : '' }}>Billing
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="saas-input" name="job_id" id="edit-job-id">
                                ...
                                @foreach($jobs as $job)
                                    <option value="{{ $job->id }}" data-category="{{ $job->category }}" {{ $interview->job_posting_id == $job->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12 mb-4 manual-pos-wrapper"
                            style="{{ $interview->job_posting_id ? 'display:none' : '' }}">
                            <label class="saas-label"><i class="fas fa-id-card-alt"></i> Position Applied (Manual /
                                Fallback)</label>
                            <input type="text" class="saas-input" name="position_applied"
                                value="{{ $interview->position_applied }}" placeholder="e.g. CSR">
                        </div>
                        <div class="col-md-12 mb-0">
                            <label class="saas-label"><i class="fas fa-map-marker-alt"></i> Current City</label>
                            <input type="text" class="saas-input" name="address" value="{{ $interview->address }}"
                ...
                <div class="saas-form-body">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="saas-input" name="qualification"
                                value="{{ $interview->qualification }}" placeholder="e.g. BBA, MCS">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="saas-label"><i class="fas fa-history"></i> Total Experience</label>
                            <input type="text" class="saas-input" name="experience" value="{{ $interview->experience }}"
                                placeholder="e.g. Fresh or 2 Years">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="saas-label"><i class="fas fa-user-friends"></i> Referral / Reference</label>
                            <input type="text" class="saas-input" name="reference" value="{{ $interview->reference }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="saas-input" name="source" value="{{ $interview->source }}"
                                placeholder="e.g. Facebook, Indeed">
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="saas-input" name="communication_skills">
                                ...
                                <option value="Poor" {{ $interview->communication_skills == 'Poor' ? 'selected' : '' }}>Poor
                                </option>
                                <option value="Average" {{ $interview->communication_skills == 'Average' ? 'selected' : '' }}>
                                    Average</option>
                                <option value="Good" {{ $interview->communication_skills == 'Good' ? 'selected' : '' }}>Good
                                </option>
                                <option value="Excellent" {{ $interview->communication_skills == 'Excellent' ? 'selected' : '' }}>Excellent</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="datetime-local" class="saas-input" name="interview_date"
                                value="{{ $interview->interview_date ? \Carbon\Carbon::parse($interview->interview_date)->format('Y-m-d\TH:i') : '' }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="saas-form-body">
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="file-upload-wrapper {{ $interview->cv_path ? 'bg-indigo-50 border-indigo-200' : '' }}"
                                onclick="document.getElementById('cv-input').click()">
                                <div class="file-upload-icon"><i class="fas fa-file-pdf"></i></div>
                                <div class="font-weight-bold small text-dark">Click to Update CV</div>
                                <div id="cv-name" class="file-name">
                                    {{ $interview->cv_path ? basename($interview->cv_path) : 'No file chosen' }}</div>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="file-upload-wrapper {{ $interview->cnic_front_path ? 'bg-indigo-50 border-indigo-200' : '' }}"
                                onclick="document.getElementById('front-input').click()">
                                <div class="file-upload-icon"><i class="fas fa-id-badge"></i></div>
                                <div class="font-weight-bold small text-dark">Update Front Side</div>
                                <div id="front-name" class="file-name">
                                    {{ $interview->cnic_front_path ? basename($interview->cnic_front_path) : 'No file chosen' }}
                                </div>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="file-upload-wrapper {{ $interview->cnic_back_path ? 'bg-indigo-50 border-indigo-200' : '' }}"
                                onclick="document.getElementById('back-input').click()">
                                <div class="file-upload-icon"><i class="fas fa-id-badge"></i></div>
                                <div class="font-weight-bold small text-dark">Update Back Side</div>
                                <div id="back-name" class="file-name">
                                    {{ $interview->cnic_back_path ? basename($interview->cnic_back_path) : 'No file chosen' }}
                                </div>
            ...
            <div class="mt-5 text-center">
                <button type="submit" class="saas-btn-submit" id="submit-btn">
                    <i class="fas fa-check-circle mr-2"></i> Update Interview Record
                </button>
                <p class="mt-4 text-muted small"><i class="fas fa-shield-alt mr-1"></i> Data integrity is preserved within
                    the HRM Intelligence Cloud.</p>
            </div>
        </form>
    </div>
@endsection
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function checkCnicDuplicate() {
                ...
                cnicCheckXhr = $.get("{{ route('admin.interviews.check-cnic') }}", {
                    cnic: val,
                    exclude_id: {{ (int) $interview->id }}
                })
                    .done(function (res) {
                        if (res && res.exists) {
                            showCnicAlert(res);
            ...
            $('#record-interview-form').on('submit', function (e) {
                ...
                btn.html('<i class="fas fa-circle-notch fa-spin"></i> Updating Entry...').attr('disabled', true);

                $.ajax({
                    url: "{{ route('admin.interviews.update', $interview->id) }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (res) {
                        if (res.success) {
                            ...
                            const redirectUrl = activeTab ? "{{ route('admin.interviews.index') }}?tab=" + activeTab : "{{ route('admin.interviews.index') }}";
