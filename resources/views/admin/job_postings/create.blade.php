...
@section('breadcrumb')
    <div class="col-sm-6 text-left">
        <h4 class="page-title interviews-header">Announce New Opportunity</h4>
                    ...
                    <form id="create-job-form">
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="title" class="form-control-saas"
                                        placeholder="e.g. Senior Medical Biller" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="timings" class="form-control-saas"
                                placeholder="e.g. 8:00 PM to 5:00 AM">
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label">Description</label>
                            <textarea name="description" class="form-control-saas" rows="4"></textarea>
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label">Requirements</label>
                            <textarea name="requirements" class="form-control-saas" rows="4"></textarea>
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label">Benefits</label>
                            <textarea name="benefits" class="form-control-saas" rows="3"></textarea>
                        </div>

                        <div class="text-right mt-5">
                            <button type="submit" class="btn btn-save shadow-primary">
                                <i class="fas fa-paper-plane mr-2"></i> Launch Vacancy
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#create-job-form').on('submit', function (e) {
                ...
                btn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-2"></i> Launching...');
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        btn.prop('disabled', false).html('<i class="fas fa-paper-plane mr-2"></i> Launch Vacancy');
                        toastr.error('Error creating vacancy. Please check inputs.');
                    }
                });
            });
        });
