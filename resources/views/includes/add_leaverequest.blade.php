        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card-body text-left">
                    ...
                    <form method="POST" id="submit-leaverequest" action="{{ route('employees.store') }}">
                        @csrf
                         ...
                         style="display:none">
                            ...
                            <div class="bootstrap-timepicker">
                                <input type="time" class="form-control timepicker" id="check_out" name="check_out"
                                    required value="{{ date('H:i', strtotime(Date('Y-m-d H:i:s'))) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="with-border" placeholder="Submit Reason..." name="leave_reason" id="leave_reason" cols="7"
                                required=""></textarea>
                        </div>
                        <div class="form-group">
                            <div>
...
<script>
    ...
    $('#submit-leaverequest').submit(function(event) {
